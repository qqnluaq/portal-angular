...
// export const SNACKBAR_DISMISS_WARNING_CONFIG = {panelClass: "snackbar-info"};
...
export function displayInfoSnackbar(service: MatSnackBar, message: string) {
    service.openFromComponent(WFSnackbarComponent, getSnackbarConfig(message, WF_SNACKBAR_TYPES.INFO));
}

export function displaySuccessSnackbar(service: MatSnackBar, message: string) {
    service.openFromComponent(WFSnackbarComponent, getSnackbarConfig(message, WF_SNACKBAR_TYPES.SUCCESS));
}
